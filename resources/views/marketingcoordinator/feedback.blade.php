            ...
            <main class="flex-1 overflow-y-auto bg-[#F1F5F9] p-4 sm:p-6 lg:p-8">
                ...
                <div class="max-w-7xl mx-auto space-y-4 mb-4">
                    ...
                    <div class="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-sm my-8">
                        <h1 class="text-3xl font-bold mb-2">Feedback Form</h1>
                        ...
                        <form class="space-y-8">
                            ...
                            <div class="flex justify-end">
                                <button type="submit" class="bg-green-400 hover:bg-green-500 text-black px-6 py-3 rounded-md text-lg font-semibold transition-colors">
                                    Submit Feedback
                                </button>
                            </div>
                        </form>

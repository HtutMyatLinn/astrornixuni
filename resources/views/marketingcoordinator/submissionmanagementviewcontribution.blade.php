        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-[#F1F5F9] p-4 sm:p-6 lg:p-8">
                ...
                <div class="max-w-7xl mx-auto space-y-4 mb-4">
                    ...
                    <div class="max-w-7xl mx-auto p-12 bg-white rounded-lg shadow-sm my-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="mt-12">
                                ...
                                <div class="flex flex-wrap gap-4">
                                    ...
                                    <button class="bg-red-400 hover:bg-red-500 text-black px-8 py-3 rounded-md text-lg font-semibold transition-colors">
                                        Reject
                                    </button>
                                    <button class="bg-blue-300 hover:bg-blue-400 text-black px-8 py-3 rounded-md text-lg font-semibold transition-colors">
                                        Give Comment
                                    </button>
                                    <a href="{{ url()->previous() }}" class=" bg-black text-white px-8 py-3 rounded-md text-lg font-semibold transition-colors">
                                        Back
                                    </a>
                                </div>
                            </div>

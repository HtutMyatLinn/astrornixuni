                ...
                <div class=" max-w-full mx-auto shadow-lg p-6 bg-white mt-4 rounded-md">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div class="p-4">
                                <img src="{{ asset('images/math.png') }}" alt="Mathematics Class XII"
                                    class="w-full h-5/6 object-cover">
                                <div class="mt-4 text-center">


                                    <a href="{{ route('marketingmanager.publishedcontributionviewdetail') }}"
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div class="p-4">
                                <img src="{{ asset('images/math.png') }}" alt="International Relations"
                                    class="w-full h-5/6 object-cover">
                                <div class="mt-4 text-center">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div class="p-4">
                                <img src="{{ asset('images/math.png') }}" alt="Adult Medical Surgical Nursing"
                                    class="w-full h-5/6 object-cover">
                                <div class="mt-4 text-center">
                                    <a href="#" class="text-blue-600 font-medium hover:underline">View</a>
                                </div>

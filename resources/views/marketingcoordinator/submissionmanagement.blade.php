        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto bg-[#F1F5F9] p-4 sm:p-6 lg:p-8">
                ...
                <div class="max-w-7xl mx-auto space-y-4 mb-4">
                    <h1 class=" text-xl sm:text-4xl font-bold text-gray-900">Review Contributions</h1>

                    <div class="max-w-7xl mx-auto">

                        <div class="p-8 bg-white  shadow-lg">
                            <!-- Header -->
                            <h1 class="text-2xl font-bold mb-6">List of Submitted Contributions</h1>
                            <!-- Search and Filters -->
                                ...
                                <table class="w-full">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <span class="px-3 py-1 rounded-full text-sm bg-[#CAF4E0] text-black">Reviewed</span>
                                            </td>
                                            <td>
                                                <a href="{{route('marketingcoordinator.submission-management.view-detail-contribution')}}" class="px-6 py-4 text-[#2F64AA]">
                                                    View
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 text-gray-600">5/7/16</td>
                                            <td class="px-6 py-4">
                                                <span class="px-3 py-1 rounded-full text-sm bg-[#81CBEF] text-black">Selected</span>
                                            </td>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 text-gray-600">5/7/16</td>
                                            <td class="px-6 py-4">
                                                <span class="px-3 py-1 rounded-full text-sm bg-[#FCD53F] text-black">Pending</span>
                                            </td>
                                            <td class="px-6 py-4 text-[#2F64AA]">
                                                View
                                            </td>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4 text-gray-600">5/7/16</td>
                                            <td class="px-6 py-4">
                                                <span class="px-3 py-1 rounded-full text-sm bg-[#65FF51] text-black">Published</span>
                                            </td>
                                            <td class="px-6 py-4 text-[#2F64AA]">
                                                View
                                            </td>

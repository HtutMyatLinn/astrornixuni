...
class InquiryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.notificationsinquiry', compact('new_inquiries', 'new_inquiry_percentage_change', 'inquiries', 'sort', 'search', 'filter', 'total_students', 'student_percentage_change', 'unassigned_users', 'assigned_user_percentage_change'));
    }

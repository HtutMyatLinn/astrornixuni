                        ...
                        <form action="{{ route('marketingcoordinator.selected-contributions') }}" method="GET">
                            <div class="flex justify-between mb-8">
                                <div class="relative w-[400px]">
                                    ...
                                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by title or student name"
                                        class="w-full pl-12 pr-4 py-2.5 rounded-lg bg-gray-100 border border-gray-300 focus:ring-2 focus:ring-blue-500" />
                                </div>
                                <div class="flex gap-4">
                                    <!-- Sort Dropdown -->
                                    <select name="sort" onchange="this.form.submit()" class="px-6 py-2.5 rounded-lg bg-[#F1F5F9] hover:bg-gray-100">

                ...
                <div class="max-w-7xl mx-auto space-y-4 mb-4">
                    ...
                    <div class="max-w-7xl mx-auto">
                        ...
                        <div class="max-w-7xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12 mb-10">
                            <h1 class="text-2xl md:text-xl font-bold text-gray-900 mb-8">Academic Year & Intake Management</h1>

                            <form class="grid md:grid-cols-2 gap-x-8 gap-y-6">
                                <div class="space-y-2">
                                    <label class="block text-start font-bold text-gray-900">Academic Year</label>
                                    <select class="w-full px-4 py-3 rounded-lg bg-gray-50 border-0 text-gray-500 focus:ring-2 focus:ring-gray-200">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="text" placeholder="Enter Final Closure Date . . ." class="w-full px-4 py-3 rounded-lg bg-gray-50 border-0 text-gray-500 focus:ring-2 focus:ring-gray-200">
                                </div>

                                <div class="space-y-2">
                                    <label class="block text-start font-bold text-gray-900">Intake</label>
                                    <input type="text" placeholder="Enter Intake . . ." class="w-full px-4 py-3 rounded-lg bg-gray-50 border-0 text-gray-500 focus:ring-2 focus:ring-gray-200">
                                </div>

                                <div class="space-y-2">
                                    <label class="block text-start font-bold text-gray-900">Closure Date</label>
                                    <input type="text" placeholder="Enter Closure Date . . ." class="w-full px-4 py-3 rounded-lg bg-gray-50 border-0 text-gray-500 focus:ring-2 focus:ring-gray-200">
                                </div>

                                <div class="md:col-span-2 flex justify-end mt-4">
                                    <button type="submit" class="px-8 py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors">
                                        Submit
                                    </button>
                                </div>
                            </form>
                        </div>
                        <h2 class="text-sm sm:text-lg text-gray-900 font-extrabold mb-10">History</h2>
                        <div class="p-8 bg-white  shadow-lg">
                            <!-- Header -->
                            <h1 class="text-2xl font-bold mb-6">List of Overall Information</h1>
                            ...
                            <div class="bg-white rounded-lg overflow-hidden">
                                <table class="w-full">
                                    <thead class="bg-[#F9F8F8]">
                                        <tr>
                                            <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Academic Year</th>
                                            <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Intake</th>
                                            <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Submission Closure Date</th>
                                            <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Final Closure Date</th>

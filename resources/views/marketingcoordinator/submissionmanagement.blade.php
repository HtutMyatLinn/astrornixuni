                                ...
                                <table class="w-full">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <span
                                                    class="px-3 py-1 rounded-full text-sm bg-[#CAF4E0] text-black">Reviewed</span>
                                            </td>
                                            <td>
                                                <a href="{{ route('marketingcoordinator.submission-management.view-detail-contribution') }}"
                                                    class="px-6 py-4 text-[#2F64AA]">
                                                    View
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <span
                                                    class="px-3 py-1 rounded-full text-sm bg-[#81CBEF] text-black">Selected</span>
                                            </td>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <span
                                                    class="px-3 py-1 rounded-full text-sm bg-[#FCD53F] text-black">Pending</span>
                                            </td>
                                            <td class="px-6 py-4 text-[#2F64AA]">
                                                View
                                            </td>
                                        ...
                                        <tr class="hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-4">
                                                <span
                                                    class="px-3 py-1 rounded-full text-sm bg-[#65FF51] text-black">Published</span>
                                            </td>
                                            <td class="px-6 py-4 text-[#2F64AA]">
                                                View
                                            </td>

                            ...
                            <table class="w-full">
                                <thead class="bg-[#F9F8F8]">
                                    <tr>
                                        ...
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Total Submissions
                                        </th>
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Published Contributions</th>
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Participation Rate
                                        </th>
                            ...
                            <table class="w-full">
                                <thead class="bg-[#F9F8F8]">
                                    <tr>
                                        ...
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Comment Date
                                        </th>
                            ...
                            <table class="w-full">
                                <thead class="bg-[#F9F8F8]">
                                    <tr>
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">No</th>
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Contributions Title</th>
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Feedback Giver
                                        </th>
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Feedback</th>
                                        <th class="text-left px-6 py-4 text-sm font-medium text-gray-500">Feedback Date
                                        </th>

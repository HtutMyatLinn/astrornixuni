        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden lg:ml-64">
            ...
            <main class="flex-1 overflow-y-auto bg-[#F1F5F9] p-4 sm:p-5">
                ...
                <div class="max-w-7xl mx-auto space-y-4 mb-4">
                    ...
                    <h1 class=" text-xl sm:text-2xl font-bold text-gray-900">Newly Submitted Contributions for Review
                    </h1>
                    <div class="p-8 bg-white  shadow-lg">
                        <!-- Header -->
                        <h1 class="text-xl font-bold mb-6">List of Newly Submitted Contributions</h1>
                        <!-- Search and Filters -->
                    ...
                    <div class="p-8 bg-white  shadow-lg mb-8">
                        <!-- Header -->
                        <h1 class="text-xl font-bold mb-6">Resubmitted Contributions (After Feedback)</h1>
                        <!-- Search and Filters -->
                        <div class="flex justify-between mb-8">
                            <div class="relative w-[400px]">
                                <svg class="absolute left-4 top-3 h-5 w-5 text-gray-400"
                    ...
                    <h1 class=" text-xl sm:text-2xl font-bold text-gray-900">Recently Registered Guest Accounts</h1>
                    <div class="p-8 bg-white  shadow-lg mb-8">
                        <!-- Header -->
                        <h1 class="text-xl font-bold mb-6">List of Newly Registered Guest</h1>
                        <!-- Search and Filters -->
                        <div class="flex justify-between mb-8">
                            <div class="relative w-[400px]">
                                <svg class="absolute left-4 top-3 h-5 w-5 text-gray-400"

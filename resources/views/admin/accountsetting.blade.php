...
<body class="bg-gray-50 min-w-[420px]">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden lg:ml-64">
                ...
                <form action="{{ route('admin.update-account-setting', Auth::user()->user_id) }}" method="POST"
                    ...
                    <div class="flex flex-col md:flex-row items-start gap-5 mb-8">
                        ...
                        <div class="profile-image-container w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden">
                            ...
                            <img id="profileImagePreview" src="{{ asset('storage/profile_images/' . Auth::user()->profile_image) }}" alt="Profile Image"
            ...
            <div id="passwordModal" class="modal">
                <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md mx-4">
                    ...
                    <form action="{{ route('admin.change-password') }}" method="POST" class="space-y-6" id="passwordForm">
    @csrf
    <div>
        <label for="oldPassword" class="block mb-2 font-medium">Old Password</label>
        <input type="password" id="oldPassword" name="old_password" placeholder="Enter Current Password"
    ...
    <div class="password-container relative">
        ...
        <div class="relative">
            ...
            <span class="password-toggle absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer" id="newPasswordToggle">
    ...
    <div class="password-container relative">
        ...
        <div class="relative">
            <input type="password" id="confirmPassword" name="new_password_confirmation" placeholder="Enter New Password Again"
                class="w-full p-3 rounded-md border border-gray-200 bg-gray-50">
            <span class="password-toggle absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer" id="confirmPasswordToggle">
                <!-- Eye Icon (Show Password) -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 eye-open" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
